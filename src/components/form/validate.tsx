...
// 类型
const types = [
  'string', 'number', 'boolean', 'method', 'integer', 'array', 'object', 'float',
  // 'url', 'email', 'regexp', 'enum', 'date', 'hex'
]
...
export const getValidateFunction = (rule: Irule) => {
...
export default (fieldName: string, rules: Array<{}>, fieldValue: any, type?: string) => {
